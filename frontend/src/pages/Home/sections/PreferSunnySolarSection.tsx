              ...
              <svg viewBox="0 0 160 170" className="w-full h-full overflow-visible" aria-label="Australia's #1 Solar Retailer">
                <defs>
                  ...
                  <filter id="crestShadow" x="-20%" y="-20%" width="140%" height="140%">
                    <feDropShadow dx="0" dy="4" stdDeviation="4" floodOpacity="0.3" floodColor="#78350F" />
                  </filter>
                </defs>
                ...
                <g opacity="0.35" stroke="#FDE68A" strokeWidth="0.8">
                ...
                <g>
                  {/* Ribbon Left Fold */}
                  <path d="M 12 115 L 26 104 L 26 126 L 12 122 Z" fill="#7C2D12" />
                  {/* Ribbon Right Fold */}
                  <path d="M 148 115 L 134 104 L 134 126 L 148 122 Z" fill="#7C2D12" />
          ...
          <div className="group relative transition-all duration-300 transform hover:-translate-y-2 flex flex-col items-center text-center">
            ...
            <div className="w-36 h-40 sm:w-40 sm:h-44 relative flex items-center justify-center filter drop-shadow-[0_8px_18px_rgba(245,158,11,0.25)] group-hover:drop-shadow-[0_14px_28px_rgba(245,158,11,0.38)] transition-all transform group-hover:scale-105 duration-300">
              <svg viewBox="0 0 160 170" className="w-full h-full overflow-visible" aria-label="72,000+ Families Powered">
                ...
                {/* Sun Glow Outer Haze */}
                <circle cx="80" cy="54" r="38" fill="none" stroke="#FEF08A" strokeWidth="1.5" strokeDasharray="3,3" opacity="0.5" />
                ...
                <path d="M 58 30 C 72 22 88 22 102 30" fill="none" stroke="#FEF08A" strokeWidth="1.4" strokeLinecap="round" opacity="0.6" />

                {/* Architectural Modern Home Silhouette */}
                {/* House Base Walls */}
                <rect x="52" y="70" width="56" height="32" rx="2" fill="#0F172A" stroke="#FDE68A" strokeWidth="1.2" />
                ...
                <polygon points="56,68 80,48 94,60 70,68" fill="#0284C7" stroke="#38BDF8" strokeWidth="0.8" />
                <line x1="68" y1="58" x2="82" y2="64" stroke="#FDE68A" strokeWidth="0.8" />
                <line x1="63" y1="63" x2="77" y2="66" stroke="#FDE68A" strokeWidth="0.8" />

                {/* Modern Window with Golden Warm Glow */}
                <rect x="60" y="78" width="12" height="12" rx="1" fill="#FEF08A" />
                <line x1="66" y1="78" x2="66" y2="90" stroke="#78350F" strokeWidth="0.8" />
                <line x1="60" y1="84" x2="72" y2="84" stroke="#78350F" strokeWidth="0.8" />

                {/* Modern Front Door */}
                <rect x="84" y="79" width="14" height="23" rx="1" fill="#1E293B" stroke="#FBBF24" strokeWidth="0.8" />
                <circle cx="94" cy="90" r="1.2" fill="#FEF08A" />

                {/* 3D Milestone Banner Plaque */}
                <g>
                  {/* Left ribbon tail */}
                  <path d="M 16 118 L 28 108 L 28 130 L 16 126 Z" fill="#7C2D12" />
                  {/* Right ribbon tail */}
                  <path d="M 144 118 L 132 108 L 132 130 L 144 126 Z" fill="#7C2D12" />
          ...
          <div className="group relativetransition-all duration-300 transform hover:-translate-y-2 flex flex-col items-center text-center">
            ...
            <div className="w-36 h-40 sm:w-40 sm:h-44 relative flex items-center justify-center filter drop-shadow-[0_8px_18px_rgba(2,132,199,0.22)] group-hover:drop-shadow-[0_14px_28px_rgba(2,132,199,0.36)] transition-all transform group-hover:scale-105 duration-300">
              <svg viewBox="0 0 160 170" className="w-full h-full overflow-visible" aria-label="1.3M+ Solar Panels Installed">
                ...
                <g fill="url(#laurelGoldBranch)" stroke="#78350F" strokeWidth="0.4">
                  {/* Left Wreath Leaves */}
                ...
                <circle cx="80" cy="74" r="50" fill="#78350F" />
                <circle cx="80" cy="74" r="48" fill="#0F172A" />
                ...
                <g transform="translate(80, 68)">
                  ...
                  />
                  {/* Grid Lines / Busbars */}
                  <line x1="-16" y1="-23" x2="16" y2="-7" stroke="#FDE68A" strokeWidth="0.7" opacity="0.9" />
                  <line x1="0" y1="-31" x2="0" y2="1" stroke="#FDE68A" strokeWidth="0.7" opacity="0.9" />
                  <line x1="-16" y1="-7" x2="16" y2="-23" stroke="#93C5FD" strokeWidth="0.5" opacity="0.7" />
                  ...
                  <polygon
                    ...
                    fill="url(#pvSiliconGrad)"
                  />
                  <line x1="-16" y1="-7" x2="16" y2="9" stroke="#FDE68A" strokeWidth="0.7" opacity="0.9" />
                  <line x1="0" y1="-15" x2="0" y2="17" stroke="#FDE68A" strokeWidth="0.7" opacity="0.9" />

                  {/* Floating Photon / Sun Energy Spark */}
                  <circle cx="24" cy="-24" r="2" fill="#FEF08A" />
                  <line x1="24" y1="-28" x2="24" y2="-20" stroke="#FEF08A" strokeWidth="1" />
                  <line x1="20" y1="-24" x2="28" y2="-24" stroke="#FEF08A" strokeWidth="1" />
                </g>

                {/* 3D Milestone Banner Plaque */}
                <g>
                  <path d="M 18 116 L 30 106 L 30 128 L 18 124 Z" fill="#7C2D12" />
                  <path d="M 142 116 L 130 106 L 130 128 L 142 124 Z" fill="#7C2D12" />
          ...
          <div className="group relative transition-all duration-300 transform hover:-translate-y-2 flex flex-col items-center text-center">
            ...
            <div className="w-36 h-40 sm:w-40 sm:h-44 relative flex items-center justify-center filter drop-shadow-[0_8px_18px_rgba(16,185,129,0.22)] group-hover:drop-shadow-[0_14px_28px_rgba(16,185,129,0.36)] transition-all transform group-hover:scale-105 duration-300">
              <svg viewBox="0 0 160 170" className="w-full h-full overflow-visible" aria-label="800MW+ Clean Energy Generated">
                <defs>
                  {/* Clean Energy Emerald Green Gradient */}
                ...
                <circle cx="80" cy="74" r="61" fill="#064E3B" />
                <circle cx="80" cy="74" r="59" fill="#022C22" />

                {/* Megawatt Instrument Markings (Circular Dial) */}
                <g stroke="#6EE7B7" strokeWidth="1" opacity="0.65">
                ...
                />
                {/* Emerald Clean-Energy Orbital Ring */}
                <ellipse
                  cx="80"
                  cy="72"
                  rx="42"
                ...
                <circle cx="80" cy="72" r="23" fill="url(#emeraldCoreGrad)" stroke="#A7F3D0" strokeWidth="1.2" />
                <circle cx="80" cy="72" r="18" fill="#064E3B" opacity="0.4" />
                ...
                <circle cx="62" cy="62" r="2" fill="#34D399" />
                <circle cx="98" cy="62" r="2" fill="#FBBF24" />
                <circle cx="80" cy="42" r="2.5" fill="#FEF08A" />

                {/* 3D Milestone Banner Plaque */}
                <g>
                  <path d="M 18 116 L 30 106 L 30 128 L 18 124 Z" fill="#064E3B" />
                  <path d="M 142 116 L 130 106 L 130 128 L 142 124 Z" fill="#064E3B" />
