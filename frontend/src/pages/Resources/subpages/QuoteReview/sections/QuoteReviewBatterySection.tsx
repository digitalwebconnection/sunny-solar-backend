...
import { BatteryCharging, Zap, Check, ArrowRight, ShieldCheck, AlertTriangle } from 'lucide-react';
import { Button } from '../../../../../components/ui/Button';

export const QuoteReviewBatterySection: React.FC = () => {
  return (
            ...
            <div className="relative overflow-hidden shadow-2xl border border-slate-700 group rounded-lg">
              ...
              <div className="absolute bottom-3.5 left-3.5 right-3.5 text-white">
                <div className="flex items-center justify-between text-xs font-semibold text-emerald-300 mb-1">
                  <span>Battery Line-Item Audit</span>
                  <span>Backup Gateway Verified</span>
                </div>
          ...
          <div className="lg:col-span-7 space-y-4">
            ...
            <div className="space-y-2.5 pt-1">
              <div className="flex items-start gap-2.5 text-xs text-slate-200">
                ...
                <span><strong>The Missing Backup Gateway:</strong> Many "cheap" quotes only include the battery unit without the automatic transfer switch ($1,500–$2,200 extra), leaving you without power during outages.</span>
              </div>
              ...
              <div className="flex items-start gap-2.5 text-xs text-slate-200">
                ...
                <span><strong>Unstated Switchboard Upgrades:</strong> If your switchboard lacks safety RCD switches or space for smart meters, shady salespeople bill you $800+ upon arrival on install morning.</span>
              </div>
              ...
              <div className="flex items-start gap-2.5 text-xs text-slate-200">
                ...
                <span><strong>Gross vs Usable Capacity Bait-and-Switch:</strong> Advertised 10 kWh batteries often only provide 8 kWh usable storage. We check true 100% Depth of Discharge (DoD) ratings.</span>
              </div>
            </div>
            ...
            <div className="pt-3 flex flex-wrap items-center justify-between gap-3 border-t border-slate-700/80">
              <div className="flex items-center gap-1.5 text-xs text-slate-300">
                ...
                <span>Zero Sales Obligation</span>
              </div>
              <Button
...
export default QuoteReviewBatterySection;
