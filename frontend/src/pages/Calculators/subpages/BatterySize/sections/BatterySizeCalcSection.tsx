            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                <label className="text-sm font-semibold text-slate-900 flex items-center gap-1.5">
                  ...
                  Active Evening Hours (5 PM – Bedtime)
                </label>
                <div className="relative flex items-center">
                  ...
                  />
                  <span className="ml-2 text-xs font-semibold text-slate-500">Hours</span>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                ...
                >
                  ...
                  <span className={`text-[10px] block mt-0.5 ${backupGoal === 'essential' ? 'text-emerald-100' : 'text-slate-400'}`}>
                    Fridge, lights, WiFi, select power points
                  </span>
                </button>
              </div>
            </div>
          ...
          <div className="lg:col-span-5  space-y-2">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
              ...
              <div className="p-3 bg-white rounded-lg border border-slate-200">
                <span className="text-[11px] font-medium text-slate-500 block">Outage Runtime</span>
                <span className="text-lg font-bold text-slate-900 mt-0.5 block">
                  {backupGoal === 'whole' ? '18 – 24 Hours' : '36 – 48 Hours'}
                </span>
                <span className="text-[10px] text-slate-400">Refills each morning via solar</span>
              </div>

              <div className="p-3 bg-white rounded-lg border border-slate-200">
                <span className="text-[11px] font-medium text-slate-500 block">Min. Solar Array Needed</span>
                <span className="text-lg font-bold text-emerald-600 mt-0.5 block">
                  8.8 kW to 10.0 kW
                </span>
                <span className="text-[10px] text-slate-400">Ensures reliable daily recharge</span>
              </div>

              <div className="col-span-full p-3 bg-white rounded-lg border border-slate-200 flex items-center justify-between">
                <div>
                  <span className="text-[11px] font-medium text-slate-500 block">Battery Chemistry</span>
                  <span className="text-base font-bold text-slate-900">Cobalt-Free LFP Lithium (10-Yr Warranty)</span>
                </div>
