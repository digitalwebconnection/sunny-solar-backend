        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center relative z-10">
          ...
          <div className="lg:col-span-5">
            <div className="relative rounded-lg overflow-hidden shadow-md group">
              ...
              <div className="absolute top-3 left-3 bg-slate-900/90 text-white px-3 py-1 rounded-full text-xs font-bold flex items-center gap-1.5 shadow-sm border border-white/20">
                <Scale className="w-3.5 h-3.5 text-amber-400" />
                <span>Battery Proposal Audit</span>
              </div>

              <div className="absolute bottom-3 left-3 right-3 text-white">
                <span className="text-[11px] font-bold text-amber-400 uppercase tracking-wider block">Watch Out for Hidden Line Items</span>
          ...
          <div className="lg:col-span-7 space-y-4">
            ...
            <div className="space-y-2 pt-1">
              <div className="flex items-start gap-2.5 text-xs text-slate-700">
                ...
                <span><strong>Is Backup Power Included?</strong> Many quotes supply "grid-tied only" batteries that shut down during grid blackouts unless an expensive backup gateway is installed.</span>
              </div>
