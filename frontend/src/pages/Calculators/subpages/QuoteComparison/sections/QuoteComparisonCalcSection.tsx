            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                <label className="text-sm font-semibold text-slate-900 flex items-center gap-1.5">
                  ...
                  Total Quoted Price (After STC Rebates)
                </label>
          ...
          <div className="lg:col-span-5  space-y-4">
            ...
            <div className="p-4 rounded-xl bg-amber-50 border border-amber-200 text-center">
              ...
              <div className="text-3xl sm:text-4xl font-serif font-bold text-amber-700 mt-1">
                ${pricePerWatt}
                <span className="text-base font-sans font-semibold text-amber-600"> / Watt</span>
              </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
              ...
              <div className="p-3 bg-white rounded-lg border border-slate-200">
                <span className="text-[11px] font-medium text-slate-500 block">Labor & Install Risk</span>
                <span className={`text-base font-bold mt-0.5 block ${
                  hasInHouseInstallers ? 'text-emerald-600' : 'text-rose-600'
                }`}>
                  {hasInHouseInstallers ? 'Low Risk (In-House)' : 'High Risk (Subcontracted)'}
                </span>
                <span className="text-[10px] text-slate-400">Direct craftsmanship backing</span>
              </div>

              <div className="p-3 bg-white rounded-lg border border-slate-200">
                <span className="text-[11px] font-medium text-slate-500 block">Hardware Tier</span>
                <span className="text-base font-bold text-slate-900 mt-0.5 block">
                  {hasEuropeanInverter ? 'Tier-1 Premium' : 'Budget Standard'}
                </span>
                <span className="text-[10px] text-slate-400">Inverter reliability rating</span>
              </div>

              <div className="col-span-full p-3 bg-white rounded-lg border border-slate-200 flex items-center justify-between">
                <div>
                  <span className="text-[11px] font-medium text-slate-500 block">Market Benchmark Standard</span>
