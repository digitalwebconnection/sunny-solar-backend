          ...
          <div className="lg:col-span-5  space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
              ...
              <div className="p-3 bg-white rounded-lg border border-slate-200">
                <span className="text-[11px] font-medium text-slate-500 block">Federal STC Rebates</span>
                <span className="text-base font-bold text-slate-900 mt-0.5 block">
                  {isEligible ? 'Eligible (~$2,800)' : 'Subject to Review'}
                </span>
                <span className="text-[10px] text-slate-400">Point-of-sale deduction</span>
              </div>

              <div className="p-3 bg-white rounded-lg border border-slate-200">
                <span className="text-[11px] font-medium text-slate-500 block">Expected Bill Reduction</span>
                <span className="text-base font-bold text-emerald-600 mt-0.5 block">
                  {isEligible ? '70% – 85% Cut' : 'Custom Estimate'}
                </span>
                <span className="text-[10px] text-slate-400">Quarterly bill offset</span>
              </div>

              <div className="col-span-full p-3 bg-white rounded-lg border border-slate-200 flex items-center justify-between">
                <div>
                  <span className="text-[11px] font-medium text-slate-500 block">Recommended Architecture</span>
                  <span className="text-sm font-bold text-slate-900">
                    {shading === 'heavy' ? 'Enphase Micro-Inverters (Per-Panel Optimisation)' : 'Tier-1 String Inverter + N-Type Panels'}
                  </span>
                </div>
