          ...
          <div className="lg:col-span-5">
            <div className="relative rounded-lg overflow-hidden shadow-md group">
              ...
              <div className="absolute bottom-3 left-3 right-3 text-white">
                <span className="text-[11px] font-bold text-amber-400 uppercase tracking-wider block">Stop Bleeding 5¢ Solar</span>
          ...
          <div className="lg:col-span-7 space-y-4">
            ...
            <div className="space-y-2 pt-1">
              <div className="flex items-start gap-2.5 text-xs text-slate-700">
                ...
                <span><strong>Zero Inverter Replacement:</strong> AC-coupled batteries wire right into your existing switchboard beside any working solar inverter.</span>
              </div>
              ...
              <div className="flex items-start gap-2.5 text-xs text-slate-700">
                ...
                <span><strong>Recharge from Legacy Panels:</strong> Whether your panels are 3 or 10 years old, they will happily charge a modern Tesla Powerwall 3 or Sungrow battery.</span>
              </div>
              ...
              <div className="flex items-start gap-2.5 text-xs text-slate-700">
                ...
                <span><strong>Instant Blackout Defense:</strong> Older solar systems shut down in blackouts. Adding a battery with an automatic gateway keeps your lights on.</span>
              </div>
            </div>
