            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <div className="relative flex items-center">
                  ...
                  />
                  <span className="ml-2 text-xs font-semibold text-slate-500">Years</span>
                </div>
              </div>
              ...
              <div className="flex items-center justify-between mb-2">
                ...
                <div className="relative flex items-center">
                  <input
                    ...
                    placeholder="5.0"
                    className="w-24 px-3 py-1 text-base font-bold text-slate-900 bg-white border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-amber-500 text-center shadow-2xs"
                  />
                  <span className="ml-2 text-xs font-semibold text-slate-500">kW</span>
                </div>
              </div>
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                <label className="text-sm font-semibold text-slate-900 flex items-center gap-1.5">
                  ...
                  Estimated Daytime Self-Consumption Rate
                </label>
                <div className="relative flex items-center">
                  <input
                    type="number"
                    ...
                    placeholder="60"
                    className="w-24 px-3 py-1 text-base font-bold text-emerald-700 bg-emerald-50 border border-emerald-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-emerald-500 text-center shadow-2xs"
                  />
          ...
          <div className="lg:col-span-5  space-y-2">
            ...
            <div className="p-4 rounded-xl bg-amber-50 border border-amber-200 text-center">
              ...
              <p className="text-xs text-amber-800/80 font-medium mt-1">
                Combined savings from avoided grid power + ${feedInEarnings.toLocaleString()} feed-in credits
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
              ...
              <div className="p-3 bg-white rounded-lg border border-slate-200">
                <span className="text-[11px] font-medium text-slate-500 block">Avoided Peak Bills</span>
                <span className="text-lg font-bold text-slate-900 mt-0.5 block">
                  ${avoidedBillCosts.toLocaleString()}
                </span>
                <span className="text-[10px] text-slate-400">Direct daytime self-use</span>
              </div>

              <div className="p-3 bg-white rounded-lg border border-slate-200">
                <span className="text-[11px] font-medium text-slate-500 block">Net Lifetime Return</span>
                <span className="text-lg font-bold text-emerald-600 mt-0.5 block">
                  +${netProfit.toLocaleString()}
                </span>
                <span className="text-[10px] text-slate-400">After full system amortisation</span>
              </div>

              <div className="col-span-full p-3 bg-white rounded-lg border border-slate-200 flex items-center justify-between">
                <div>
                  <span className="text-[11px] font-medium text-slate-500 block">Annual Clean Generation</span>
