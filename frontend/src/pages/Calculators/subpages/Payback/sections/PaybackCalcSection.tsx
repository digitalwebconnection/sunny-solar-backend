          ...
          <div className="lg:col-span-7 space-y-6">
              ...
              <div className="flex items-center justify-between mb-2">
                ...
                <div className="relative flex items-center">
                  ...
                  <input
                    ...
                    placeholder="6800"
                    className="w-36 pl-7 pr-3 py-1 text-base font-bold text-amber-700 bg-amber-50 border border-amber-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-amber-500 text-right shadow-2xs"
                  />
                </div>
              </div>
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <div className="relative flex items-center">
                  <span className="absolute left-3 text-slate-700 font-bold text-sm pointer-events-none">$</span>
                  <input
                    type="number"
                    min="100"
                    max="5000"
                    ...
                    placeholder="850"
                    className="w-32 pl-7 pr-3 py-1 text-base font-bold text-slate-900 bg-white border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-amber-500 text-right shadow-2xs"
                  />
                </div>
              </div>
          ...
          <div className="lg:col-span-5  space-y-2">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
              ...
              <div className="p-3 bg-white rounded-lg border border-slate-200">
                <span className="text-[11px] font-medium text-slate-500 block">Annual Bill Savings</span>
                <span className="text-lg font-bold text-slate-900 mt-0.5 block">
                  ${annualSavings.toLocaleString()} / yr
                </span>
                <span className="text-[10px] text-slate-400">Avoided power costs</span>
              </div>

              <div className="p-3 bg-white rounded-lg border border-slate-200">
                <span className="text-[11px] font-medium text-slate-500 block">10-Year ROI</span>
              ...
              <div className="col-span-full p-3 bg-white rounded-lg border border-slate-200 flex items-center justify-between">
                <div>
                  <span className="text-[11px] font-medium text-slate-500 block">Estimated 10-Year Net Profit</span>
