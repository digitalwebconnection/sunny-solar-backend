...
export const PaybackAddBatterySection: React.FC = () => {
  return (
    <section className="">
      <div className="relative  bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 text-white p-6 sm:p-8 md:p-10 overflow-hidden shadow-xl border border-slate-700/80">
        {/* Glow dots */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center relative z-10">
          ...
          <div className="lg:col-span-5">
            <div className="relative rounded-lg overflow-hidden shadow-2xl border border-slate-700 group">
              <img
              ...
              <div className="absolute top-3 left-3 bg-emerald-500/90 text-slate-950 px-3 py-1 rounded-full text-xs font-bold flex items-center gap-1.5 shadow-sm">
                <TrendingUp className="w-3.5 h-3.5" />
                <span>Arbitrage ROI Multiplier</span>
              </div>

              <div className="absolute bottom-3 left-3 right-3 text-white">
                <span className="text-[11px] font-bold text-amber-400 uppercase tracking-wider block">Energy Tariff Spread</span>
          ...
          <div className="lg:col-span-7 space-y-4">
            ...
            <div className="grid grid-cols-2 gap-3 pt-1">
              ...
              <div className="p-3 rounded-xl bg-emerald-950/40 border border-emerald-500/30">
                ...
                <span className="text-base font-extrabold text-emerald-300">38¢ – 44¢ / kWh</span>
