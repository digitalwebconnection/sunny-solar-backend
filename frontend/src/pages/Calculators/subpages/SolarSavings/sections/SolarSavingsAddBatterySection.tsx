      ...
      <div className="relative  bg-gradient-to-tr from-slate-900 via-slate-800 to-slate-900 text-white p-6 sm:p-8 md:p-10 overflow-hidden shadow-xl border border-slate-700/80">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center relative z-10">
          ...
          <div className="lg:col-span-5">
            <div className="relative  overflow-hidden shadow-2xl border border-slate-700 group">
              <img
              ...
              <div className="absolute top-3 left-3 bg-emerald-500/90 backdrop-blur-md px-3 py-1 rounded-full text-slate-950 text-xs font-extrabold flex items-center gap-1.5">
                <BatteryCharging className="w-3.5 h-3.5" />
                <span>+Battery Storage Upgrade</span>
              </div>

              <div className="absolute bottom-3 left-3 right-3 text-slate-200">
                <div className="flex items-center justify-between text-xs mb-1 font-bold text-amber-400">
